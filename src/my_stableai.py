...
def create_linkedin_post_stableai(post, prompt, model='Stable Diffusion v1.6', hashtags=['datascience', 'llm']):
    print(f'{post}\n\n')
    print(f'\n\nPS: The image was generated by {model} using the following prompt: "{prompt.strip()}".')
